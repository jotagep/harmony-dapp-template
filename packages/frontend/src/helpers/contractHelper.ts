...
export const getDonationContractFromConnector = async (connector: AbstractConnector, web3Provider: any): Promise<any> => {
	...
	const web3Contract = new web3.eth.Contract(Contracts.contracts.Donation.abi as any, Contracts.contracts.Donation.address);
	return web3Contract;
}